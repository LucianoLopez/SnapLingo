...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mEmailEditText.setText("student0@school.com");
        this.mPasswordEditText.setText("student");
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            Intent goToPremise = new Intent(LoginActivity.this, PremiseActivity.class);
            goToPremise.putExtra("username", user.getDisplayName());
            goToPremise.putExtra("uid", user.getUid());

            System.out.println("UID is " + user.getUid());

            startActivity(goToPremise);
